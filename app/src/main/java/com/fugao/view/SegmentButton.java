...
public class SegmentButton extends LinearLayout implements View.OnClickListener {
	...
	private void setView() {
		...
		if (buttonCount == 1) {
			...
			button.setLayoutParams(new LayoutParams(140,
	...
	/**
	 * @Title: setButtonContent
	 * @Description: TODO
	 * @param contentStrList
	 *            各个button的内容集合
	 * @return: void
	 */
	public void setButtonContent(ArrayList<String> contentStrList) {
		this.removeAllViews();
		this.buttonContent = "";
		for (String string : contentStrList) {
			buttonContent = buttonContent + string + ",";
		}
		setButtonCount();
		setView();
	}
	 ...
	 * @return: void
	 */
	public void setButtonContent(String contentStr) {
		this.removeAllViews();
		this.buttonContent = contentStr;
		setButtonCount();
		setView();
	}
