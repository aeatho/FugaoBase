 ...
 */
public class UpdateDialgoFragmentV4 extends DialogFragment {
	...
	public static UpdateDialgoFragmentV4 newInstance(String apkurl,
			String sdcardPath) {
		UpdateDialgoFragmentV4 updateDialgoFragment = new UpdateDialgoFragmentV4();
	...
	public static UpdateDialgoFragmentV4 newInstance(String apkurl,
			String sdcardPath,String updateLogs) {
		UpdateDialgoFragmentV4 updateDialgoFragment = new UpdateDialgoFragmentV4();
		Bundle bundle = new Bundle();
		bundle.putString("apk_url", apkurl);
		bundle.putString("sdcardPath", sdcardPath);
		bundle.putString("updateLogs", updateLogs);
		updateDialgoFragment.setArguments(bundle);
		return updateDialgoFragment;
	}
	@Override
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		updateLogs=getArguments().getString("updateLogs");
	...
	public void initView() {
		...
		textProgressRate=(TextView) currentView.findViewById(R.id.textProgressRate);
		textVersionMsg=(TextView) currentView.findViewById(R.id.textVersionMsg);
		textVersionMsg.setText(updateLogs);
	}
				...
				new AjaxCallBack<File>() {
					...
					public void onLoading(long count, long current) {
						...
						if (count > 0) {
							...
							textProgressRateString=updateProgress+"%"+current+"KB/"+count+"KB";
							Log.i("down", textProgressRateString + "--" + updateProgress+"--"+rate);
					...
					public void onFailure(Throwable t, int errorNo,
						...
						Toast.makeText(fatherActivity, "更新失败!", Toast.LENGTH_SHORT).show();
