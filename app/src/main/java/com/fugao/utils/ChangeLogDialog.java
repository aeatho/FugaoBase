...
public class ChangeLogDialog {
    ...
    private int changeTitleID;
    private int closeID;
    public ChangeLogDialog(final Context context,int changelogID,int changeTitleID,int closeID) {
        mContext = context;
        this.changeLogID=changelogID;
        this.changeTitleID=changeTitleID;
        this.closeID=closeID;
    }

    public ChangeLogDialog(final Context context,int changelogID,int changeTitleID) {
        mContext = context;
        this.changeLogID=changelogID;
        this.changeTitleID=changeTitleID;
    }
    ...
    public String getHTML() {
        ...
        return getHTMLChangelog(changeLogID, resources, 0);    	
    }
    ...
    protected void show(final int version) {
        ...
        //Get dialog title	        	
        String title = resources.getString(changeTitleID);
        title = String.format("%s v%s", title, getAppVersion());

        //Create html change log
        final String htmlChangelog = getHTMLChangelog(changeLogID, resources, version);

        //Get button strings
        final String closeString = resources.getString(R.string.alert_close);
